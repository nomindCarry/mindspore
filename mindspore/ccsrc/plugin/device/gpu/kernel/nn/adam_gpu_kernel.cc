...
std::vector<std::pair<KernelAttr, AdamGpuKernelMod::AdamLaunchFunc>> AdamGpuKernelMod::func_list_ = {
  {KernelAttr()
     ...
     .AddOutputAttr(kNumberTypeFloat64)
     .AddOutputAttr(kNumberTypeFloat64),
   &AdamGpuKernelMod::LaunchKernel<double>},
  {KernelAttr()
  ...
  {KernelAttr()
     ...
     .AddOutputAttr(kNumberTypeInt64)
     .AddOutputAttr(kNumberTypeInt64),
   &AdamGpuKernelMod::LaunchKernel<int64_t>},
  {KernelAttr()
     ...
     .AddOutputAttr(kNumberTypeInt32)
     .AddOutputAttr(kNumberTypeInt32),
   &AdamGpuKernelMod::LaunchKernel<int32_t>},
  {KernelAttr()
     ...
     .AddOutputAttr(kNumberTypeInt16)
     .AddOutputAttr(kNumberTypeInt16),
   &AdamGpuKernelMod::LaunchKernel<int16_t>},
  {KernelAttr()
     ...
     .AddOutputAttr(kNumberTypeInt8)
     .AddOutputAttr(kNumberTypeInt8),
   &AdamGpuKernelMod::LaunchKernel<int8_t>},
  {KernelAttr()
     ...
     .AddOutputAttr(kNumberTypeUInt64)
     .AddOutputAttr(kNumberTypeUInt64),
   &AdamGpuKernelMod::LaunchKernel<uint64_t>},
  {KernelAttr()
     ...
     .AddOutputAttr(kNumberTypeUInt32)
     .AddOutputAttr(kNumberTypeUInt32),
   &AdamGpuKernelMod::LaunchKernel<uint32_t>},
  {KernelAttr()
     ...
     .AddOutputAttr(kNumberTypeUInt16)
     .AddOutputAttr(kNumberTypeUInt16),
   &AdamGpuKernelMod::LaunchKernel<uint16_t>},
  {KernelAttr()
     ...
     .AddOutputAttr(kNumberTypeUInt8)
     .AddOutputAttr(kNumberTypeUInt8),
   &AdamGpuKernelMod::LaunchKernel<uint8_t>},
  {KernelAttr()
     ...
     .AddOutputAttr(kNumberTypeComplex128)
     .AddOutputAttr(kNumberTypeComplex128),
   &AdamGpuKernelMod::LaunchKernel<std::complex<double>>},
  {KernelAttr()
     ...
     .AddOutputAttr(kNumberTypeComplex64)
     .AddOutputAttr(kNumberTypeComplex64),
   &AdamGpuKernelMod::LaunchKernel<std::complex<float>>},
};
